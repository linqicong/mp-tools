 ...
 * @version 1.0
 */
public class UserBatchUnTaggingRequest extends BaseRequest<NoParamResponse> {

    private String url = "https://api.weixin.qq.com/cgi-bin/tags/members/batchuntagging";
