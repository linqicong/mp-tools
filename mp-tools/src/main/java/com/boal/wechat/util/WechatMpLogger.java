...
import com.boal.wechat.Constants;
...
public class WechatMpLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        WechatMpLogger.needEnableLogger = needEnableLogger;
    }
...
//     * 发生特别错误时记录完整错误现场
//     */
//    public static void logErrorScene(Map<String, Object> rt, response tRsp,
//                                     String appSecret) {
//        if (!needEnableLogger) {
//            return;
//        }
...
//     * 发生特别错误时记录完整错误现场
//     */
//    public static void logBizSummary(Map<String, Object> rt, response tRsp,
